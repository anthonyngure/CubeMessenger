<?php
	 ...
	 * @property string
	 *                   $account_type     user - general public, driver - those who do transportation
	 * @property int|null
	 *                   $driver_option_id applies to drivers account only
	 * @property string|null
	 *                   $status           applies to drivers account only
	 * @property float|null
	 *                   $latitude
	 * @property float|null
	 *                   $longitude
